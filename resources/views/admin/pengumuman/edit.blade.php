...
<div class="max-w-2xl">
    <form action="{{ route('admin.pengumuman.update', $pengumuman) }}" method="POST" class="space-y-5">
        ...
        <div class="glass-card p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="isi" rows="5"
                    class="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('isi', $pengumuman->isi) }}</textarea>
            </div>
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    <label class="text-gray-700 text-sm mb-2 block font-medium">Expired</label>
        ...
        <div class="flex gap-3">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 inline-flex items-center gap-2">Update Pengumuman</button>
